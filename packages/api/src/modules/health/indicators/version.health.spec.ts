...
const mockVersion = vi.fn<() => string | undefined>();
...
describe('VersionHealthIndicator', () => {
  ...
  let mockHealthCheck: { up: Mock; down: Mock };
  ...
  beforeEach(async () => {
    ...
    const healthIndicatorServiceMock = {
      check: vi.fn().mockReturnValue(mockHealthCheck),
    } as unknown as Mocked<HealthIndicatorService>;
