...
import { authUserFactory, AuthUser } from '@/modules/auth/decorators/auth-user.decorator.js';
...
describe('AuthUser', () => {
  ...
  it('should call switchToHttp on execution context', () => {
    // Arrange
    const switchToHttpSpy = vi.spyOn(mockExecutionContext, 'switchToHttp');
  ...
  it('should call getRequest on http context', () => {
    ...
    const getRequestSpy = vi.spyOn(httpContext, 'getRequest');
